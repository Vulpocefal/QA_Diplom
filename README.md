...
1. Для просмотра отчетов, сгенерированных Allure Report, необходимо поставить Allure CLI. Не забудьте добавить путь к папке bin внутри директории Allure CLI в переменные среды вашей ОС (PATH).
